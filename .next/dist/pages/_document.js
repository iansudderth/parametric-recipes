...
var MyDocument = function (_Document) {
  ...
  (0, _createClass3.default)(MyDocument, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('html', { lang: 'en', dir: 'ltr' }, _react2.default.createElement(_document.Head, null, _react2.default.createElement('title', null, 'My page'), _react2.default.createElement('meta', { charSet: 'utf-8' }), _react2.default.createElement('meta', {
        name: 'viewport',
        content: 'user-scalable=0, initial-scale=1, ' + 'minimum-scale=1, width=device-width, height=device-height'
      }), _react2.default.createElement('link', { rel: 'manifest', href: '/static/manifest.json' }), _react2.default.createElement('meta', { name: 'theme-color', content: context.theme.palette.primary[500] }), _react2.default.createElement('link', {
        rel: 'stylesheet',
